---
description: How to "unstuck" any pending transactions that are stuck in your MetaMask
---

# Fixing Stuck Pending Transactions on MetaMask

![](../.gitbook/images/stuck-transaction-header.png)
