...
If zDEX in the prize pools isn't won it doesn't go to waste! Unclaimed zDEX rolls over to the next Lottery round.
...
- cheaper ticket prices (\~$5 USD in zDEX per ticket) that don't swing wildly with the price of zDEX
...
Each bracket's prize pool is a portion of the total zDEX in each Lottery round.

- | Bracket (numbers matched in order) | zDEX Allocation |
  | ---------------------------------- | --------------- |
  | First 1 number                     | 2%              |
  | First 2 numbers                    | 3%              |
  | First 3 numbers                    | 5%              |
...
## Can I swap my tickets back to zDEX?

No, once purchased you will not be able to convert your ticket back to zDEX.

## If I win, do I need to manually claim the prize?

Yes, you will need to click the **Check Now** button under "Are you a winner?" on the Lottery page.

![](<../../.gitbook/images/image (150).png>)
...
![Lottery injection schedule](<../../.gitbook/images/Lottery Schedule Update Feb 4.png>)
...
## Injection schedule: When is zDEX added to the lottery?

When people buy tickets, the zDEX they spend is added to the lottery pot. In addition, 10,000 zDEX is also added (injected) to the lottery pot every other round on a regular schedule over the course of seven rounds per week as shown above in the lottery schedule figure.
