...
ZexdexApp's Lottery is not only a good way to make stacks of zDEX, it's also loads of fun! This guide will walk you through getting involved in the Lottery.

{% hint style="info" %}
The Lottery has changed a little since its first iteration. Lottery v2 lets you win more often, have some control over your tickets, and has more potential for huge zDEX jackpots to get your mouth watering. Learn more about [ZexdexApp Lottery v2 here](https://docs.zexdex.app/products/lottery).
{% endhint %}
...
You just need a little zDEX though: each ticket costs approximately $5 USD (the exact zDEX price is set at the start of the round).
