...
![](../../.gitbook/images/how-to-yield-farms-bscscan-header.png)

Since it requires several steps, using Farms with ZexdexApp can seem intimidating at first. This guide will walk you through using the Farms contract directly through BscScan.

{% hint style="warning" %}
Please understand that using BscScan to interact with contracts is not recommended for beginners. If you're not feeling confident, we suggest using the [How to Use Farms guide](https://docs.zexdex.app/products/yield-farming/how-to-use-farms) instead.
{% endhint %}
...
1\. Open the [ZexdexApp website’s Farms code on GitHub](https://github.com/panzDEXswap/panzDEX-frontend/blob/master/src/config/constants/farms.ts).

2\. **Control**/**command** + **F** and search for your pair by ticker (not project name). For example, 'zDEX-BUSD'.

![](<../../.gitbook/images/image (112).png>)
...
But assuming you'd like to confirm that, visit the [ZexdexApp: Main Staking Contract BscScan page](https://bscscan.com/address/0x73feaa1ee314f8c655e354234017be2193c9e24e#writeContract). You'll see the address in the top-left. Click the **pages icon** to copy this to clipboard. You'll need it soon.

![](<../../.gitbook/images/image (116).png>)
...
1\. First, open [farms.ts on GitHub](https://github.com/panzDEXswap/panzDEX-frontend/blob/master/src/config/constants/farms.ts).

2\. **Control**/**command** + **F** and search for your pair by ticker (not project name). For example, 'zDEX-BNB'

![](<../../.gitbook/images/image (132).png>)
...
![](<../../.gitbook/images/image (133).png>)

### From the UI

1\. First, visit the [ZexdexApp Farms page](https://zexdex.app/farms) and search for your chosen pair using the "SEARCH" field in the top right. We're using zDEX-BUSD for this example.

![](<../../.gitbook/images/image (113).png>)

2\. Click **Details** to expand the row to show more information.

![](<../../.gitbook/images/image (114).png>)

3\. Click **View Contract** to open the smart contract on BscScan.

![](<../../.gitbook/images/image (115).png>)
...
![](<../../.gitbook/images/image (118).png>)

5\. You’re also going to need to approve the amount of LP Tokens the contract can spend. In the value field, you’ll need to enter the amount in Wei. You can use the [BscScan Unit Converter](https://www.bscscan.com/unitconverter) to easily change your amount into Wei. Here we'll use 5 zDEX-BUSD LP Tokens.

![](<../../.gitbook/images/image (158).png>)
...
1\. Back on the [ZexdexApp: Main Staking Contract BscScan page](https://bscscan.com/address/0x73feaa1ee314f8c655e354234017be2193c9e24e#writeContract), go to **Contract**, and then **Write Contract**.
...
{% hint style="danger" %}
**Using the emergency withdraw function will forfeit your zDEX rewards!**

The ZexdexApp team strongly suggests avoiding this function unless advised to do so officially by the ZexdexApp team, or if you are very comfortable interacting with smart contracts and understand the underlying code.
{% endhint %}

‌1. On the [ZexdexApp: Main Staking Contract BscScan page](https://bscscan.com/address/0x73feaa1ee314f8c655e354234017be2193c9e24e#writeContract), go to **Contract**, and then **Write Contract**.
